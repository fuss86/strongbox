        ...
        extends RawRestAssuredBaseTest
{
            ...
            throws Exception
    {
        ...
        Repository repository1 = rawRepositoryFactory.createRepository(REPOSITORY_RELEASES);
        ...
        Repository repository2 = rawRepositoryFactory.createRepository(REPOSITORY_GROUP);
