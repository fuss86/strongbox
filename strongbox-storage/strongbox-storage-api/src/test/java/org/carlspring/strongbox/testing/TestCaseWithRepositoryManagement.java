...
public abstract class TestCaseWithRepositoryManagement extends TestCaseWithRepository
{
    ...
    public void createRepositoryWithFile(Repository repository,
                                         String storageId,
                                         String path)
            throws IOException, JAXBException, RepositoryManagementStrategyException
    {
    ...
    public void createFile(String storageId,
            ...
            throws IOException
    {
        ImmutableRepository repository = configurationManagementService.getConfiguration().getRepository(storageId, repositoryId);

        createFile(repository, path);
    }

    public void createFile(ImmutableRepository repository,
                           String path)
            throws IOException
    {       
